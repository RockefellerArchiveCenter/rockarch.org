...
### Strategic Framework
To build a path towards a sustainable and expansive future for the RAC and its Archives Program, we focus our work on the following three areas:
- Our Values: Embedding the organization’s values in our daily work.
- Our People: Committing to ongoing, collective, and active learning.
- Our User Communities: Engaging, understanding, and centering people in everything we do.
